...
#define BASE 836 
#define ITERS 1
#define DELTA 1        // Right now only set up to do one size
...
#define O_ITERS 19        // # of OMEGA values to be tested
#define PER_O_ITERS 1    // trials per OMEGA value
double OMEGA = 1.81;     // OMEGA base - first OMEGA tested
